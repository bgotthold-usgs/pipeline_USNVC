...
#        Useage example: ch_ledger.log_change_event("Field Creation", "Creating feature_id field from REG_NUM", source_data, changed_data)
# send_final_result: instance of a method that acepts a python object representation of a single row of processed data
# send_to_stage: instance of a method that acepts a python object representation of a single row of data that will be processed by the next stage and the integer stage to send it to. 
